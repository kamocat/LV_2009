...
<Project Type="Project" LVVersion="9008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="circle perimeter.vi" Type="VI" URL="../../../function libraries/Mathematics/circle perimeter.vi"/>
			<Item Name="filter to finite value.vi" Type="VI" URL="../../../function libraries/Mathematics/filter to finite value.vi"/>
			<Item Name="find closest match.vi" Type="VI" URL="../../../function libraries/Array/find closest match.vi"/>
			<Item Name="interleave array around index.vi" Type="VI" URL="../../../function libraries/Array/interleave array around index.vi"/>
			<Item Name="concatenate to radians.vi" Type="VI" URL="../../../function libraries/Mathematics/concatenate to radians.vi"/>
			<Item Name="weighted average.vi" Type="VI" URL="../../../function libraries/Mathematics/weighted average.vi"/>
		</Item>
